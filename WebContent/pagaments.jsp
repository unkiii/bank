    ...
    <div id="wrapper">
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="index.jsp"><i class="fa fa-money"></i> <span class="nav-label">Pagaments</span></a>
                    </li>
        ...
        <div class="row  border-bottom white-bg dashboard-header">
                ...
                <!-- Comprova quins comptes te i els mostra -->
                    ...
                    <table border='0'>    
                    <tr align="">
                    	<td width=10%>ID Factura</td>
                    	<td width=10%>Empresa</td>
                    	<td width=10%>Quantitat</td>
                    	<td width=10%>Data</td>
                    	<td width=10%>Pagat</td>
                    </tr>                	
	           			<% 
	           				int cont= 0;
	           				while(cont <= 5){
